...
//        let url = "https://api.github.com/search/repositories?q=created:>2019-03-07&sort=stars&order=desc"
...
//                do {
//                    let results = try JSONDecoder().decode(GitRepositoriesResponse.self, from: data)
//                    var urls = [URL]()
//                    self.repos = []
//                    
...
//                
//            }
//            .catchError({ (err) -> Observable<[GitRepository]> in
//                print(err.localizedDescription)
//                
...
//}
//
////"https://api.github.com/search/repositories?q=created:%3E2017-10-22&sort=stars&order=desc" -i -v
